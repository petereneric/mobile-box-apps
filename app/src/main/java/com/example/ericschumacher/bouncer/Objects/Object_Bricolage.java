...
public class Object_Bricolage {
    ...
    public Object_Bricolage(Context context, JSONObject oJson) {
        ...
        try {
            ...
            if (!oJson.isNull(Constants_Extern.DEPTHS)) {
                nDepths = oJson.getInt(Constants_Extern.DEPTHS);
            }
    ...
    public int getnDepths() {
        return nDepths;
    }

    public void setnDepths(int nDepths) {
        this.nDepths = nDepths;
    }
