...
public class ViewHolder_Choice_New extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public ViewHolder_Choice_New (View itemView, Interface_Click iClick, Interface_Long_Click iLongClick) {
        super(itemView);
