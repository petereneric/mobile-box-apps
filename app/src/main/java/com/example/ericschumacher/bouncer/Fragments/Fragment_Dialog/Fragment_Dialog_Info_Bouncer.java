...
public class Fragment_Dialog_Info_Bouncer extends Fragment_Dialog {
    ...
    private void loadData() {
        cVolley.getResponse(Request.Method.GET, Urls.URL_GET_STATISTIC_BOUNCER, null, new Interface_VolleyResult() {
            @Override
            public void onResult(JSONObject oJson) throws JSONException {
                tvContent.setText(oJson.getString("sDevices"));
            }
        });
    }
