...
public class Adapter_List_Protocol_Single extends Adapter_List {
    ...
    ArrayList<ProtocolWipe> lProtocolWipe = new ArrayList<>();

    public Adapter_List_Protocol_Single(android.content.Context context, Interface_Adapter_List iAdapterList, ArrayList<ModelWipe> lModelWipes, ArrayList<ProtocolWipe> lProtocolWipe) {
        super(context, iAdapterList);
        this.lModelWipes = lModelWipes;
        this.lProtocolWipe = lProtocolWipe;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            case Constants_Intern.ERROR:
                ...
                vhList.ivLeft.setVisibility(View.VISIBLE);
                vhList.tvLeft.setVisibility(View.GONE);
                Utility_Layout.setBackgroundColor(Context, vhList.vDividerLeft, R.color.color_red);
                Utility_Image.setImageResource(Context, vhList.ivLeft, R.drawable.ic_clear_24dp, R.color.color_red);

                // Middle
                vhList.tvSubtitle.setVisibility(View.GONE);
                Utility_Layout.setTextColor(Context, vhList.tvTitle, R.color.color_red);
                vhList.tvTitle.setText(Context.getString(R.string.abort_protocol_due_defect));
                break;
        }
    }

    public void updateData(ArrayList<ModelWipe> lModelWipes, ArrayList<ProtocolWipe> lProtocolWipe) {
        this.lModelWipes = lModelWipes;
        this.lProtocolWipe = lProtocolWipe;
